...
TP3_BPS = float(os.getenv("TP3_BPS","120.0"))
SL_ROI_PCT = float(os.getenv("SL_ROI_PCT","0.01"))
TP1_RATIO = float(os.getenv("TP1_RATIO","0.3"))
TP2_RATIO = float(os.getenv("TP2_RATIO","0.45"))
...
TCN_CKPT = os.getenv("TCN_CKPT", "../multimodel/tcn_best_new_coin.pt")
