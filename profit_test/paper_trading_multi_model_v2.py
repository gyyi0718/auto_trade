# paper_trading_multi_model_v2.py
# -*- coding: utf-8 -*-
"""
TCN V2 모델 기반 페이퍼 트레이딩 시스템
- train_tcn_5minutes_v2.py로 학습한 AdvancedTCN_V2 모델 사용
...
MODEL_PATHS = {
    ...
    "ZEUSUSDT": "D:/ygy_work/coin/multimodel/models_5min_zeus_v2/model_v2_best.pt",
    ...
    "JELLYJELLYUSDT": "D:/ygy_work/coin/multimodel/models_5min_jellyjelly_v2/model_v2_best.pt"
}
...
TRADE_LOG_FILE = os.getenv("TRADE_LOG_FILE", "trades_v2.json")
...
# ===== AdvancedTCN_V2 모델 정의 (train_tcn_5minutes_v2.py와 동일) =====
...
def main():
    ...
    print(f"{'사용 모델: ' + str(len(MODELS)) + '개 AdvancedTCN_V2':^110}")
    print("=" * 110)
